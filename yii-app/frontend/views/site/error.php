...
<div class="site-error">
    <div class="d-flex align-items-center justify-content-center flex-column gap-4 mt-5 mb-5">
            <div>
                <svg width="317" height="113" viewBox="0 0 317 113" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.1">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M171 27C147.252 27 128 46.2518 128 70C128 93.7482 147.252 113 171 113C194.748 113 214 93.7482 214 70C214 46.2518 194.748 27 171 27ZM140 70C140 52.8792 153.879 39 171 39C188.121 39 202 52.8792 202 70C202 87.1208 188.121 101 171 101C153.879 101 140 87.1208 140 70Z" fill="#4c5d8d"></path>
                    </g>
                    <path class="fill-theme-svg" d="M55.5018 1.1279C58.1926 3.0619 58.8061 6.81103 56.8721 9.50181L17.7015 64H51V47C51 43.6863 53.6863 41 57 41C60.3137 41 63 43.6863 63 47V64H78C81.3137 64 84 66.6863 84 70C84 73.3137 81.3137 76 78 76H63V92C63 95.3137 60.3137 98 57 98C53.6863 98 51 95.3137 51 92V76H6.00002C3.74932 76 1.6879 74.7404 0.660974 72.7376C-0.365956 70.7348 -0.185663 68.3258 1.12793 66.4982L47.1279 2.49818C49.0619 -0.192605 52.8111 -0.806099 55.5018 1.1279Z" fill="#4c5d8d"></path>
                    ...
                    <path class="fill-theme-svg" d="M274.872 9.50181C276.806 6.81103 276.193 3.0619 273.502 1.1279C270.811 -0.806099 267.062 -0.192605 265.128 2.49818L219.128 66.4982C217.814 68.3258 217.634 70.7348 218.661 72.7376C219.688 74.7404 221.749 76 224 76H269V92C269 95.3137 271.686 98 275 98C278.314 98 281 95.3137 281 92V76H296C299.314 76 302 73.3137 302 70C302 66.6863 299.314 64 296 64H281V47C281 43.6863 278.314 41 275 41C271.686 41 269 43.6863 269 47V64H235.702L274.872 9.50181Z" fill="#4c5d8d"></path>
                </svg>
            </div>
            ...
            <div>
                <a class="btn btn-lg error_button p-3" href="/"><span>На главную</span></a>
            </div>
    </div>
